  ...
  return (
    <View>
      ...
      <View>
        <View style={[baseStyles.borderTop, styles.infoItem]}>
          <View>
            <Text style={[styles.comLeftTxt, baseStyles.text14, styles.leftWider]}>实际佣金点数：</Text>
          </View>
          <View>
            <Text style={[styles.comRightTxt, baseStyles.text14]}>{store.brokerageProportion} %</Text>
          </View>
        </View>
        <View style={[baseStyles.borderTop, styles.infoItem]}>
          <View>
            <Text style={[styles.comLeftTxt, baseStyles.text14, styles.leftWider]}>定佣：</Text>
          </View>
          <View>
            <Text style={[styles.comRightTxt, baseStyles.text14]}>{store.fixedCommission} 元</Text>
          </View>
        </View>
        <View style={[baseStyles.borderTop, styles.infoItem]}>
          <View>
